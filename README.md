...
The Unity project also includes a monitor-based academic training mode with an endoscopic camera, minimap, three difficulty levels, wall collisions, score, and anonymous local CSV results. It works with keyboard/mouse or the experimental ESP32 + MPU6050 text controller documented in `docs/PHYSICAL_CONTROLLER.md`.
